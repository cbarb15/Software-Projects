...

{
    ...
    window = glfwCreateWindow( WIDTH, HEIGHT, "Final Project - Normal Map", NULL, NULL);
...
//    "vec3 lightPos = vec3(0.0f, 1.0f, 3.0f);"
    ...
    "uniform sampler2D teapotTexture, normalMap;"
...
//        "  vec3 normal = texture(normalMap, vec2(FragTex.x, 1024 - FragTex.y)).rgb;"
    "  vec3 normal = texture(normalMap, FragTex.xy).rgb;"
    // Transform normal vector to range [-1,1]
    "   normal = normalize(normal * 2.0 - 1.0);"
    
    
    "   vec3 color = texture(teapotTexture, FragTex.xy).rgb;"
...
//        "   FragColor = vec4(mod(FragTex.xy, vec2(1.0)), 0.0, 1.0f);"
...
//    lodepng::decode(brickImage, width, height, "/Users/CharlieBarber/Desktop/brickwall.png");
...
//        lodepng::decode(brickNormalMapImage, normWidth, normHeight, "/Users/CharlieBarber/Desktop/lion.png");


    
    glGenTextures(1, &teapotNormalMapTexture);
    glActiveTexture(GL_TEXTURE1);
    glBindTexture(1, teapotNormalMapTexture);
