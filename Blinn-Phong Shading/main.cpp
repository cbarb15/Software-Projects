...
//  HW2
//
//  Created by Charlie Barber on 1/28/17.
...
//  HW1_CS5610
//
//  Created by Charlie Barber on 1/22/17.
//  Copyright © 2017 Charlie Barber. All rights reserved.
//
...
void loadShadersAndDraw()
{
    ...
    //Specular
     ...
     "float spec = pow(max(dot(normVector, halfwayVector), 0.0), 32.0);"
     "vec3 specular =  vec3(10.0) * spec * lightColor;"
