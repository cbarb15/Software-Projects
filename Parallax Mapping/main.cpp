...

{
    ...
    window = glfwCreateWindow( WIDTH, HEIGHT, "Final Project - Parallax Map", NULL, NULL);
...
//    "vec3 lightPos = vec3(0.0f, 1.0f, 3.0f);"
    ...
    "   vec3 newOffsetFragTex = FragTex;"
    "   vec3 viewDir = normalize(TangentCamPos - TangentFragPos);"

    "   float heightOfA = texture(depthMap, FragTex.xy).r;"
    "   vec3 pVector = TangentCamPos / TangentCamPos.z * (heightOfA * heightScale);"
    "   newOffsetFragTex -= pVector;"
