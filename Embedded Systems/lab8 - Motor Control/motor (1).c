...
void pwm_init(void) {
    ...
    //PA7 is set high
		//GPIOB->ODR |= GPIO_MODER_MODER7;
		//PA8 is set low
		//GPIOB->ODR &= ~(1 << 6);  //ALL 1'S WITH A 0 IN THE 6TH SPOT
...
void encoder_init(void) {
    ...
    //DO I NEED TO DO THIS CAUSE IT'S DONE ABOVE OR BECAUSE IT'S IN A DIFFERENT FUNCTION IT LOSES IT'S SCOPE??   
     ...
     */ 
		 //Based on 80RPM's and 160 encoder counts
    TIM6->PSC = 7;  
    TIM6->ARR = 37500; // 15000microSeconds  
